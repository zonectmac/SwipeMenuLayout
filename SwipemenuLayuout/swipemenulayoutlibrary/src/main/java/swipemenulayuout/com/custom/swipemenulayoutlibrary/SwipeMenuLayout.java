package swipemenulayuout.com.custom.swipemenulayoutlibrary;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                } else if (attr == R.styleable.SwipeMenuLayout_contentMenuView) {
                    mContentViewResID = typedArray.getResourceId(R.styleable.SwipeMenuLayout_contentMenuView, -1);
                } else if (attr == R.styleable.SwipeMenuLayout_canLeftMenu) {
                    mCanLeftSwipe = typedArray.getBoolean(R.styleable.SwipeMenuLayout_canLeftMenu, true);
                } else if (attr == R.styleable.SwipeMenuLayout_canRightMenu) {
                    mCanRightSwipe = typedArray.getBoolean(R.styleable.SwipeMenuLayout_canRightMenu, true);
